...
/**
 * Test for /provider/inquiry
 */
Test('/provider/inquiry', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test countCards get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/provider/inquiry']['get']['responses']['200']['schema']);
