...
/**
 * Test for /order/{id}/status
 */
Test('/order/{id}/status', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getOrderItemStatus get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/order/{id}/status']['get']['responses']['200']['schema']);
